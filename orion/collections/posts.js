...
Posts.attachSchema(new SimpleSchema({
	...
	*/
	...
	contributor: orion.attribute('hasOne', {
		label: 'Contributor relation'
	}, {
		collection: Contributors,
		titleField: 'name',
		publicationName: 'postContributors',
		create: function (input, cb) {
			var contributor = Contributors.insert({name: input, published: false});
			var newContributor = Contirbutors.findOne(contirbutor);
			cb(newContributor);
		}
...
Posts.helpers({
	...
	getContributor: function () {
		return Contributors.findOne({ _id: this.contributor });
	}
});